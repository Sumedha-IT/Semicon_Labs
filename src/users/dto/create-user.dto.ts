import { IsEmail, IsString, IsOptional, IsDateString, IsEnum, MinLength, IsNumber, Length, Matches, IsPositive } from 'class-validator';
...
export class CreateUserDto {
  ...
  @IsEmail({}, { message: 'Email must be in valid format (e.g., user@domain.com)' })
  email: string;
  ...
  @Matches(/^[a-zA-Z0-9\s\-,\.]+$/, { message: 'Location can only contain letters, numbers, spaces, hyphens, commas, and periods' })
  location: string;
